package br.com.entrevista.santander.adapters;
...
import br.com.entrevista.santander.R;
import br.com.entrevista.santander.utils.RecyclerViewOnClickListenerHack;
...
public class StatementsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        ((StatementViewHolders) holder).tv_date_statement.setText(Utilidades.formatDatePt(item.getDate()));
        ((StatementViewHolders) holder).tv_desc_statement.setText(item.getDesc());

        Utilidades.setCurrencyText(((StatementViewHolders) holder).tv_balance_statement, item.getValue());
    }
